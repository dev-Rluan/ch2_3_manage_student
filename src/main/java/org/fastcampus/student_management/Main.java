...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    StudentInfoDto studentInfoDto2 = new StudentInfoDto("홍길동", 20, "서울시 강남구");
    studentService.saveStudent(studentInfoDto1);
    studentService.saveStudent(studentInfoDto2);

    CourseInfoDto courseInfoDto1 = new CourseInfoDto("바이올린", 1000, "MONDAY","홍길동",1234L);
    CourseInfoDto courseInfoDto2 = new CourseInfoDto("첼로", 1000, "MONDAY","홍길동",1234L);
